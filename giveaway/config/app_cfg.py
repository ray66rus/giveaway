# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in giveaway.
...
import giveaway
from giveaway import model, lib
...
base_config.model = giveaway.model
base_config.DBSession = giveaway.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "d253377a-3539-4437-94fe-bb19e427a2dc"
